...
INSERT INTO DIETS(diet_name, diet_description) VALUES
  ('Diet 1', 'asjdisajdisajdsiajdaa'),
  ('Diet 2', 'mvbcvmbvkbnnbvbnvbnvkbn'),
  ('Diet 3', 'kfgpohotrhoioghifpoihpogihop');

-- INSERT INTO PROFESSIONALS(rating, work_zone, user_id) VALUES
--   (5, 'Pozuelo', 3),
--   (10, 'Aravaca', 4);
