    -- ====================== ENTRENADORES ==================== --
  -- therock, Dwayne2020#, BASIC
  -- rockyboalboa, Rocky2020#, BASIC
  -- terminator, Terminator2020#, BUSINESS
  -- themountain, Hafthor2020#, BUSINESS

  -- ====================== CLIENTES ======================= --
  -- lukamagic, Luka2020#, FREE
  -- jamorant, Morant2020#, FREE
  -- kingjames, Lebron2020#, FREE
  -- mrtripledouble, Westbrook2020#, FREE
  -- easymoneysniper, Durant2020#, PREMIUM
  -- greekfreak, Giannis2020#, PREMIUM
  -- hisairness, Jordan2020#, PREMIUM
  -- drose, Rose2020#, PREMIUM
...
INSERT INTO MODEL_USERS (first_name, last_name, user_name, password, email, birth_date, role_id, enabled) VALUES
